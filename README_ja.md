...
| 対象 | 適用ライセンス |
| --- | --- |
| `paper/` 内の論文PDF・TeX、`README.md`、`README_ja.md`、`docs/` 内のMarkdown文書（履歴文書を含む） | **CC BY 4.0（表示 4.0 国際）** — [概要](https://creativecommons.org/licenses/by/4.0/deed.ja)・[正式な条文](https://creativecommons.org/licenses/by/4.0/legalcode.ja) |
